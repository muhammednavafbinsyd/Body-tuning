...
import testi1 from "../assets/img/testimonial/testimonial-1.jpg";
import testi2 from "../assets/img/testimonial/quote-left.png";
// import testi3 from "../assets/img/testimonial/testimonial-1.jpg";
// import testi4 from "../assets/img/testimonial/quote-left.png";
...
function Home() {
  ...
  const TestimonialsGet = async () => {
    try {
      const response = await axios.get("http://localhost:2000/userroute/testimonialList");
  ...
  const membership = async () => {
    try {
      const response = await axios.get("http://localhost:2000/userroute/membership");
            ...
            {list.map((item, index) => (
              <div key={index} className="col-lg-4">
                <div
                  ...
                  style={{ backgroundImage: `url(http://localhost:2000/uploads/${item.image})` }}
                >
                ...
                <div className="testimonial-slider owl-carousel">
                  <div className="testimonial-item">
                    ...
                    <div className="ti-pic">
                      <img src={`http://localhost:2000/uploads/${item.image}`} alt />
                      <div className="quote">
                        <img src={testi2} alt />
                      </div>
                    </div>
