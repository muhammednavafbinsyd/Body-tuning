...
function workoutview() {
  ...
  const gettype = async (id) => {
    try {
      const response = await axios.get(`http://localhost:2000/userroute/typeGet/${id}`);
  ...
  const geteditworkoutplan = async (id) => {
    try {
      const response = await axios.get(`http://localhost:2000/userroute/trainerworkoutplanview/${id}`);
